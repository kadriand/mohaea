...
public class ElitistMOHAEAFixedOffspring<T extends Individual> extends Algorithm<T> {

    public ElitistMOHAEAFixedOffspring(List<GeneticOperator<T>> geneticOperators, TerminationCondition<T> terminationCondition, SelectionMethod<T> selectionMethod, PopulationInitialization<T> initialization, FitnessCalculation<T> fitnessCalculation) {
    ...
    public Population<T> apply() {
        ...
        for (T indvidual : parentsPopulation)
            indvidual.setFitness(fitnessCalculation.computeIndividualFitness(indvidual, parentsPopulation));
